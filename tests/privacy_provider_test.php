...
use enrol_sslcommerz\privacy\provider;
use core_privacy\local\request\writer;

/**
 * Class enrol_sslcommerz_privacy_provider_testcase.
 *
 * @package    enrol_sslcommerz
 * @copyright  2021 Brain station 23 ltd.
 * @author     Brain station 23 ltd.
...
class enrol_sslcommerz_privacy_provider_testcase extends \core_privacy\tests\provider_testcase {
    ...
    /** @var stdClass A user whose email address matches the receiver_email field in some of the sslcommerz transactions. */
    ...
    public function test_get_metadata() {
        ...
        $this->assertEquals('sslcommerz.com', $location->get_name());
        $this->assertEquals('privacy:metadata:enrol_sslcommerz:sslcommerz_com', $location->get_summary());
        ...
        $this->assertEquals('enrol_sslcommerz', $table->get_name());
        $this->assertEquals('privacy:metadata:enrol_sslcommerz:enrol_sslcommerz', $table->get_summary());
    ...
    public function test_export_user_data() {
        ...
        $this->export_context_data_for_user($this->student1->id, $coursecontext1, 'enrol_sslcommerz');
    ...
    public function test_export_user_data_not_enrolled() {
        ...
        // Export all of the data for the context.
        $this->export_context_data_for_user($this->student2->id, $coursecontext1, 'enrol_sslcommerz');
        $writer = writer::with_context($coursecontext1);
    ...
    public function test_export_user_data_no_enrolment() {
        ...
        // Export all of the data for the context.
        $this->export_context_data_for_user($this->student0->id, $coursecontext1, 'enrol_sslcommerz');
        $writer = writer::with_context($coursecontext1);
        $this->assertFalse($writer->has_any_data());
    }
    ...
    public function test_export_user_data_multiple_sslcommerz_history() {
        ...
        $this->setUser($this->student2);
        // Export all of the data for the context.
        $this->export_context_data_for_user($this->student2->id, $coursecontext2, 'enrol_sslcommerz');
    ...
    public function test_delete_data_for_users() {
        ...
        // After deletion, sslcommerz transactions for student12 in course1 should have been deleted.
        // Now, we should have 1 sslcommerz transaction (which is not related to student12) in course1.
        // There should still be 3 sslcommerz transactions (1 of them for student12) in course2.
    ...
    public function test_delete_data_for_users_business() {
        ...
        $this->assertEquals(3, $DB->count_records('enrol_sslcommerz', ['business' => $this->businessuser1->email]));
        $transactions = $DB->get_records('enrol_sslcommerz', [
        ...
        $this->assertEquals(2, $DB->count_records('enrol_sslcommerz', ['business' => $this->businessuser1->email]));
        $this->assertEquals(0, $DB->count_records('enrol_sslcommerz', [
            'courseid' => $this->course1->id,
            'business' => $this->businessuser1->email
        ]));
        ...
        $newtransaction = $DB->get_record('enrol_sslcommerz', ['id' => $transaction->id]);
    ...
    public function test_delete_data_for_users_receiver() {
        ...
        $this->assertEquals(2, $DB->count_records('enrol_sslcommerz', ['receiver_email' => $this->receiveruser1->email]));
        $transactions = $DB->get_records('enrol_sslcommerz', [
            'courseid' => $this->course1->id,
        ...
        $this->assertEquals(0, $DB->count_records('enrol_sslcommerz', ['receiver_email' => $this->receiveruser1->email]));
    ...
    protected function setUp(): void {
        ...
        $sslcommerzplugin->enrol_user($enrolinstance1, $this->student1->id, $studentrole->id);
        $this->create_enrol_sslcommerz_record(
            $this->businessuser1,
            $this->receiveruser1,
            $this->course1,
            $this->student1,
        ...
        $sslcommerzplugin->enrol_user($enrolinstance2, $this->student2->id, $studentrole->id);
        ...
        // First in course1.
        $sslcommerzplugin->enrol_user($enrolinstance1, $this->student12->id, $studentrole->id);
        $this->create_enrol_sslcommerz_record(
            $this->businessuser2,
            $this->receiveruser1,
            $this->course1,
        ...
        // Then in course2.
        $sslcommerzplugin->enrol_user($enrolinstance2, $this->student12->id, $studentrole->id);
        $this->create_enrol_sslcommerz_record(
            $this->businessuser2,
            $this->receiveruser2,
            $this->course2,
        ...
        $sslcommerzplugin->enrol_user($enrolinstance1, $this->student3->id, $studentrole->id);
        $this->create_enrol_sslcommerz_record(
            $this->businessuser3,
            $this->receiveruser3,
            $this->course3,
